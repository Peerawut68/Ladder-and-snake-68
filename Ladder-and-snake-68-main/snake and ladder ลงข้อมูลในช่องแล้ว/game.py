...
from ladders_snakes_pos import get_position_coordinates
...
class Game:
    ...
    def play_turn(self, draw_board):
        ...
        if self.current_player == 1:
            self.player1.move(steps, self.screen, draw_board, self.draw_players)
            self.current_player = 2
        else:
            self.player2.move(steps, self.screen, draw_board, self.draw_players)
            self.current_player = 1