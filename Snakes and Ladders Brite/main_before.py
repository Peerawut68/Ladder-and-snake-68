...
f3 = pygame.font.Font("Chewy.ttf",215)
...
#การแสดงผลหน้าต่างๆ
def draw_home():
    global order, x1, y1, x2, y2, x3, y3, x4, y4
    bg("Picture/Home.png")
...
draw = False
def draw_game():
    global order, x1, y1, x2, y2, x3, y3, x4, y4, u_tern, break_time, draw, dice
            ...
            if break_time > 0:
                ...
                for i in range(dice):
                    if y1 in (915, 775, 635, 495, 355, 215):
                        ...
                        if y1 == 145 and x1 < 138:
                            u_tern = True
                        if u_tern == True:
                            x1 += 95
                        else:
                            x1 -= 95
                        if x1 < 138 and y1 != 145:
                            y1 -= 70
                            x1 = 138
                    if draw == True:
                        vid.draw(screen, (0, 0))
                        pygame.display.update()
                        draw_text(str(dice),f3,(0,0,0),(w//2),(h//2))
                        pygame.display.update()
                        draw = False
                    bg("Picture/Background.png")
                    create_chr(3)
                ...
                for i in range(dice):
                    if y2 in (925, 781, 637, 493, 349, 205):
                        ...
                        if y2 == 133 and x1 < 188:
                            u_tern = True
                        if u_tern == True:
                            x2 += 95
                        else:
                            x2 -= 95
                        if x2 < 188 and y2 != 133:
                            y2 -= 72
                            x2 = 188
                    bg("Picture/Background.png")
                ...
                for i in range(dice):
                    if y3 in (879, 741, 603, 465, 327, 189):
                        ...
                        if y3 == 120 and x1 < 130:
                            u_tern = True
                        if u_tern == True:
                            x3 += 95
                        else:
                            x3 -= 95
                        if x3 < 130 and y3 != 120:
                            y3 -= 69
                            x3 = 130
                    bg("Picture/Background.png")
                    draw_text(str(dice),f2,(0,0,0),0,0)
                ...
                for i in range(dice):
                    if y4 in (879, 741, 603, 465, 327, 189):
                        ...
                        if y4 == 120 and x1 < 192:
                            u_tern = True
                        if u_tern == True:
                            x4 += 95
                        else:
                            x4 -= 95
                        if x4 < 192 and y4 != 120:
                            y4 -= 69
                            x4 = 192
                    bg("Picture/Background.png")
                    draw_text(str(dice),f2,(0,0,0),0,0)
