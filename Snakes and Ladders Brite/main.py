...
y4 = 879
players = [
    Player(x1, y1, player_01_img, w, h),
    Player(x2, y2, player_02_img, w, h),
    Player(x3, y3, player_03_img, w, h),
    Player(x4, y4, player_04_img, w, h)
]
...
#การแสดงผลหน้าต่างๆ
def draw_home():
    global x1, y1, x2, y2, x3, y3, x4, y4, order
    bg("Picture/Home.png")
